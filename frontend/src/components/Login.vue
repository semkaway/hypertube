		...
		<b-row>
			...
			<b-col sm="5" lg="4" class="mt-4 mb-5" :class="{'hideForm': hideForm}">
				<h1>{{ $t("login.title") }}</h1>
					...
					<b-button href="https://api.intra.42.fr/oauth/authorize?client_id=5b2ec6bcbe8d7d9fa32d6129854aa36ea010afa550ec096b3733bc8cf388d0a7&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2Fintra&response_type=code" variant="dark">42 Intra</b-button>
